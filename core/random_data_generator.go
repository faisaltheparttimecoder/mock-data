...
// Random string array
func RandomStringArray(strlen int) string {
	...
	return "{" + strings.Join(resultArrayCollector, ",") + "}"
}
...
// Random number generated by array.
func RandomIntArray(min, max int) (string, error) {
	maxValues,_ := RandomInt(0, 6)
	maxIteration, _ := RandomInt(0, 3)
	var resultArrayCollector []string
	for i := 0; i < maxIteration; i++ { // Max number of arrays
		var resultArray []string
		for j := 0; j < maxValues; j++ { // max number of values in a array.
			value, err := RandomInt(min, max)
			if err != nil {
				return "", err
			}
			resultArray = append(resultArray, strconv.Itoa(value))
		}
		resultArrayCollector = append(resultArrayCollector, "{" + strings.Join(resultArray, ",") + "}")
	}
...
func RandomfloatArray(min, max, precision int) (string, error) {
	maxValues,_ := RandomInt(0, 6)
	maxIteration, _ := RandomInt(0, 3)
	var resultArrayCollector []string
	for i := 0; i < maxIteration; i++ { // Max number of arrays
		var resultArray []string
		for j := 0; j < maxValues; j++ { // max number of values in a array.
			value, err := RandomFloat(min, max, precision)
			if err != nil {
				return "", err
			}
			value = TruncateFloat(value, max, precision)
			resultArray = append(resultArray, strconv.FormatFloat(value, 'f', precision, 64))
		}
		resultArrayCollector = append(resultArrayCollector, "{" + strings.Join(resultArray, ",") + "}")
	}
	return "{" + strings.Join(resultArrayCollector, ",") + "}" , nil
...
// Random Date Array
func RandomDateArray(fromyear, toyear int) (string, error) {
	maxValues,_ := RandomInt(0, 6)
	maxIteration, _ := RandomInt(0, 3)
	var resultArrayCollector []string
	for i := 0; i < maxIteration; i++ { // Max number of arrays
...
// Random Timestamp without time zone Array
func RandomTimestampArray(fromyear, toyear int) (string, error) {
	maxValues,_ := RandomInt(0, 6)
	maxIteration, _ := RandomInt(0, 3)
	var resultArrayCollector []string
	for i := 0; i < maxIteration; i++ { // Max number of arrays
...
// Random Timestamp with time zone Array
func RandomTimestamptzArray(fromyear, toyear int) (string, error) {
	maxValues,_ := RandomInt(0, 6)
	maxIteration, _ := RandomInt(0, 3)
	var resultArrayCollector []string
	for i := 0; i < maxIteration; i++ { // Max number of arrays
...
// Random Time without time zone Array
func RandomTimeArray(fromyear, toyear int) (string, error) {
	maxValues,_ := RandomInt(0, 6)
	maxIteration, _ := RandomInt(0, 3)
	var resultArrayCollector []string
	for i := 0; i < maxIteration; i++ { // Max number of arrays
...
// Random Time with time zone Array
func RandomTimetzArray(fromyear, toyear int) (string, error) {
	maxValues,_ := RandomInt(0, 6)
	maxIteration, _ := RandomInt(0, 3)
	var resultArrayCollector []string
	for i := 0; i < maxIteration; i++ { // Max number of arrays
...
// Random Paragraphs array
func RandomParagraphsArray() string {
	maxValues,_ := RandomInt(0, 6)
	maxIteration, _ := RandomInt(0, 3)
	var resultArrayCollector []string
	for i := 0; i < maxIteration; i++ { // Max number of arrays
...
// Random bit Array
func RandomBitArray(max int) string {
	maxValues,_ := RandomInt(0, 6)
	maxIteration, _ := RandomInt(0, 3)
	var resultArrayCollector []string
	for i := 0; i < maxIteration; i++ { // Max number of arrays
